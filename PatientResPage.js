...
const PatientResPage = () => {
  ...
  const downloadAsPDF = () => {
    ...
    return (
    <div className="container1" style={!error ? { } : {height: '100vh'}}>
  ...
  <div key={index} id="content-to-download">
    ...
    <h2 style={{fontSize:25, fontWeight: 'bold'}}>Report Details:</h2>
      ...
      {!error && <button onClick={downloadAsPDF} disabled={!reportDetails}>Download as PDF</button>}
